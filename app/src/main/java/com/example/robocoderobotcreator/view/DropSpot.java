 ...
 */
   ...
   private int mSavedBackground = R.color.blue_200;
        ...
        DragView dragView, Object dragInfo)
{
    ...
    */
    ...
    System.out.println("DROPSPOT.onDrop accepts view: " + v.getId()
...
{
    toast ("onDragEnter");
    int bg = isEnabled () ? R.color.radar_color : R.color.events_color;
